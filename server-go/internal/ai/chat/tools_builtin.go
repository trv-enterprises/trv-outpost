	...
	reg.Register(Tool{
		...
		InputSchema: map[string]interface{}{
			...
			"properties": map[string]interface{}{
				...
				"timestamp_column": map[string]interface{}{"type": "string", "description": "Time column (RFC3339 or epoch, seconds or millis). Sorts the series and enables time-based output (window timestamps, per-second slope, hour/day buckets)"},
				...
				"max_rows":         map[string]interface{}{"type": "integer", "description": "Cap rows fetched for analysis (default and max 50000)"},
			},
