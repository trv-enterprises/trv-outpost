...
type ChartDataMapping struct {
	...
	YAxisLabel     string              `json:"y_axis_label" bson:"y_axis_label"`                           // AXIS label rendered along the Y axis (single-axis charts; dual-axis sides inherit their series label). Series/legend labels live in YAxisLabels. The old save-path mirror (YAxisLabels[0] copied here) was removed; strip_y_axis_label_mirror cleaned stored copies.
