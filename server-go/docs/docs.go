...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/connections/{id}/discover-devices": {
            "post": {
        ...
        "/connections/{id}/discovered-values": {
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.SaveDiscoveredValuesRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/connections/{id}/edgelake/databases": {
            "get": {
        ...
        "/connections/{id}/edgelake/schema": {
            "get": {
        ...
        "/connections/{id}/edgelake/tables": {
            "get": {
        ...
        "/connections/{id}/prometheus/labels/{label}/values": {
            "get": {
        ...
        "/connections/{id}/variable-values": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Column whose distinct values to list",
                        "name": "column",
                        "in": "query",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "Source table (required for SQL/EdgeLake)",
                        "name": "table",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Max distinct values (default 1000)",
                        "name": "limit",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Streaming capture window",
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.VariableValuesResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.VariableCandidatesResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.EdgeLakeTerminalExecuteRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.EdgeLakeTerminalExecuteResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                    ...
                    "502": {
                        "description": "EdgeLake node returned an error",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
                    ...
                    "504": {
                        "description": "Per-call timeout exceeded",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/frigate/{connection_id}/event/{event_id}/clip": {
            "get": {
        ...
        "/frigate/{connection_id}/event/{event_id}/snapshot": {
            "get": {
        ...
        "/frigate/{connection_id}/events/{camera}": {
            "get": {
        ...
        "/frigate/{connection_id}/live/{camera}": {
            "get": {
        ...
        "/frigate/{connection_id}/reviews/viewed": {
            "post": {
        ...
        "/frigate/{connection_id}/snapshot/{camera}": {
            "get": {
        ...
        "/registry/connections/{typeId}/guidance": {
            "get": {
        ...
        "/snippets": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Host surface key (e.g. edgelake-terminal)",
                        "name": "context",
                        "in": "query",
                        "required": true
                    }
        ...
        "/streams/multiplex/{sid}/subs": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Session ID from the ` + "`" + `session` + "`" + ` frame",
                        "name": "sid",
                        "in": "path",
                        "required": true
                    },
                    {
                        "description": "Add/remove deltas",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.MultiplexSubsRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/service.ProbeConnectionResult"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/service.TSStoreAggregatedRulesResponse"
                        }
                    },
                    "403": {
                        "description": "Extension disabled",
    ...
    "definitions": {
        ...
        "handlers.EdgeLakeTerminalExecuteRequest": {
            "type": "object",
            "required": [
                "command",
                "connection_id"
        ...
        "handlers.EdgeLakeTerminalExecuteResponse": {
            "type": "object",
            "properties": {
                "command": {
                    "type": "string"
        ...
        "handlers.MultiplexSubsRequest": {
            "type": "object",
            "properties": {
                "add": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/handlers.MultiplexAddSub"
                    }
                },
                "remove": {
                    "type": "array",
        ...
        "models.ChartDataMapping": {
            ...
            "properties": {
                ...
                "column_formats": {
                    "description": "For dataview only: column name -\u003e value format (\"compact\" SI 127G, \"duration\", \"duration_clock\", \"plain\"). Missing/\"auto\" = default cell formatting. Same format vocabulary as the number tile (number-formats.js).",
                    "type": "object",
                    "additionalProperties": {
                        "type": "string"
                    }
                ...
                "column_rules": {
                    "description": "For dataview only: column name -\u003e conditional-formatting rules. Evaluated top-down, FIRST MATCH WINS (the order is the author's logic, so it must be preserved as given).",
                    "type": "object",
                    "additionalProperties": {
                        "type": "array",
                        "items": {
                            "$ref": "#/definitions/models.ColumnRule"
                        }
                    }
                },
                "column_widths": {
                ...
                "y_axis_colors": {
                    "description": "Per-column series color overrides (resolved hex; \"\" = auto palette). Index-aligned to YAxis, same parallel-array pattern as YAxisLabels (the wire y_axis is a string array). Not applied to pivot charts (Series set). Omitted when no column has an explicit color.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "models.ColumnRule": {
            ...
            "properties": {
                "color": {
                    "description": "Hex color applied on match",
                    "type": "string"
                },
                "op": {
                    "description": "Match operator: eq, contains, gt, lt, empty",
                    "type": "string"
                },
                "target": {
                    "description": "What to paint: \"text\" (default) or \"both\" (text + background, text paired for contrast)",
                    "type": "string"
                },
                "value": {
                    "description": "Operand. Unused by \"empty\"; a blank operand on any other operator makes the rule inert (a half-typed rule must not match every row).",
                    "type": "string"
                },
                "wholeRow": {
                    "description": "When true the whole row is painted, not just this cell. If rules in several columns claim the row, the leftmost column wins.",
                    "type": "boolean"
                }
            }
        },
        ...
        "models.DashboardVariable": {
            ...
            "properties": {
                "connection_swap": {
                    "$ref": "#/definitions/models.ConnectionSwapConfig"
                },
                "filter_value": {
                    "$ref": "#/definitions/models.FilterValueConfig"
                },
                "label": {
                    "description": "UI label, e.g. \"Site\"",
                    "type": "string"
                },
                "mode": {
        ...
        "models.FilterValueConfig": {
            ...
            "properties": {
                ...
                "options": {
                    "description": "selectable values when ValueSource == \"static\"; also the seeded fallback list for \"connection\"",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "models.SaveDiscoveredValuesRequest": {
            "type": "object",
            "required": [
                "column"
            ],
            "properties": {
                "column": {
                    "description": "the column the list is for",
                    "type": "string"
                },
                "partial": {
                    "description": "true when capture was cut short",
                    "type": "boolean"
                },
                "values": {
        ...
        "models.Snippet": {
            ...
            "properties": {
                ...
                "context": {
                    "description": "e.g. \"edgelake-terminal\"",
                    "type": "string"
                },
                "created": {
                    "type": "string"
        ...
        "models.SwapFamily": {
            ...
            "properties": {
                "panel_ids": {
                    "description": "panels bound to this family (override families only)",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "primary": {
                    "description": "true for the variable's own Tags",
                    "type": "boolean"
                },
                "resolutions": {
                    "description": "Resolutions holds one entry per key value the family resolves; a value\nabsent here is a no-match for this family (the panel renders its\nempty state rather than baseline data).",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.SwapResolution"
                    }
                },
                "tags": {
                    "description": "normalized family tags",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "models.VariableCandidate": {
            "type": "object",
            "properties": {
                "compatible": {
                    "description": "passes the variable's SchemaStrict check",
                    "type": "boolean"
                },
                "id": {
                    "type": "string"
                ...
                "reason": {
                    "description": "why incompatible (empty when compatible)",
                    "type": "string"
                },
                "reference": {
                    "description": "the connection the panels currently use (the baseline)",
                    "type": "boolean"
                },
                "tags": {
                    "description": "Tags is the connection's tag set, carried so the client can derive a\ndropdown label from a prefixed tag (see ConnectionSwapConfig.LabelTagPrefix).",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "models.VariableCandidatesResponse": {
            "type": "object",
            "properties": {
                "candidates": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.VariableCandidate"
                    }
                },
                "families": {
                    "description": "primary + each distinct panel connection_tags set, with per-value resolution",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.SwapFamily"
                    }
                },
                "key_prefix": {
                    "description": "the LabelTagPrefix the values were extracted with",
                    "type": "string"
                },
                "selection": {
                    "description": "Tag-value mode additions (Selection == SwapSelectionTagValue). Empty in\nconnection mode. Candidates above still lists the PRIMARY family's\nconnections in both modes, so existing clients keep working.",
                    "type": "string"
                },
                "values": {
                    "description": "distinct selectable key values, sorted",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.SwapTagValue"
                    }
                },
                "variable": {
                    "type": "string"
        ...
        "models.VariableValuesResponse": {
            ...
            "properties": {
                ...
                "partial": {
                    "description": "Partial is true when a streaming capture was cut short (timeout / client\nstop / cap) and the list may be incomplete.",
                    "type": "boolean"
                },
                "success": {
                    "type": "boolean"
        ...
        "service.CreateAlertRequest": {
            ...
            "properties": {
                ...
                "cooldown": {
                    "description": "\"5m\" etc., ts-store duration",
                    "type": "string"
                },
                "dashboard_id": {
        ...
        "service.TSStoreAggregatedRulesResponse": {
            "type": "object",
            "properties": {
                "errors": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/service.TSStoreFetchError"
                    }
                },
                "rules": {
                    "type": "array",
