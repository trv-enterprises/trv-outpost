          ...
          <FormGroup legendText="Namespace">
            <div className="namespace-section">
              <NamespaceSelect
                ...
                onChange={(ns) => {
                  setAlertNamespace(ns);
                  // The user has taken ownership of the value; the
                  // "taken from the connection" warning no longer applies.
                  setNamespaceFromConnection(false);
                }}
              ...
              {namespaceFromConnection && (
                <InlineNotification
                  ...
                  lowContrast
                  hideCloseButton
                  title="Namespace taken from the connection"
                  subtitle="This rule doesn’t record one yet, so its alerts have been filed into the connection’s namespace. Saving records that on the rule."
                />
              )}
              {namespaceMismatch && (
                <InlineNotification
